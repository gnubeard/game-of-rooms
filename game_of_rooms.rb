# gryfft's adventure game "A Game of Rooms" (original code)
# Taken from http://www.reddit.com/r/learnprogramming/comments/rgrsi/my_first_crime_against_ruby_adventure_game_work/
